  ...
  render() {
    return (
      <View style={ styles.buttonContainer }>
        ...
        <TouchableHighlight
          style={ styles.button }
          onPress={ () => this.props.navigation.navigate('Greeting', {title: 'Greeting screen'}) }
          underlayColor='#000' >
            <Text style={ styles.buttonText }>[3rd day] Greeting screen</Text>
        </TouchableHighlight>

        <TouchableHighlight
          style={ styles.button }
          onPress={ () => this.props.navigation.navigate('MemberList', {title: 'MemberList screen'}) }
          underlayColor='#000' >
        ...
        <TouchableHighlight
          style={ styles.button }
          onPress={ () => this.props.navigation.navigate('CountDown', {title: 'CountDown screen'}) }
          underlayColor='#000' >
